...
namespace SaafiMoney.Controllers
{
    public class RecordsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Amount,Created")] Record record)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Amount,Created")] Record record)
        {
            if (id != record.ID)
            {
                return NotFound();
